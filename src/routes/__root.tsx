...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Lottie 实战学习 v6 · 系统路径",
      },
      {
        name: "description",
        content:
          "Lottie 中文交互教程：对齐 LottieFiles 官方 llms：路径、文档地图、Live Demo、图鉴与动画工坊。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('lottie-learn-ctp-flavor');var a=localStorage.getItem('lottie-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['green','mauve','blue','lavender','sapphire','teal','peach','pink'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='mauve';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','mauve');}})();";
