    ...
    <div className="mx-auto max-w-3xl pb-16">
      <header className="mb-6">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted">
          官方提供{" "}
          <a href="https://developers.lottiefiles.com/llms.txt" target="_blank" rel="noreferrer" className="text-primary no-underline hover:underline">developers.lottiefiles.com/llms.txt</a>
          {" "}
          等多份索引。本站另发布{" "}
